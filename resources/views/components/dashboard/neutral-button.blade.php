...
@php
    ...
    $classes = 'bg-back-neutral dark:bg-back-dark-neutral border border-back-base-300 dark:border-back-dark-base-300 rounded-md text-center font-medium ' . $sizes[$size] . ' text-back-light shadow-xs enabled:hover:bg-back-neutral/70 enabled:dark:hover:bg-back-dark-neutral/70 focus:outline-hidden focus:ring-1 focus:ring-back-base-300 dark:focus:ring-back-dark-base-300 focus:ring-offset-1 disabled:opacity-40 transition ease-in-out duration-150';
@endphp
