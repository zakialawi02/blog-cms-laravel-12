...
@php
    ...
    $classes = 'bg-white dark:bg-back-dark-light border border-back-base-300 dark:border-back-dark-base-300 rounded-md text-center font-medium ' . $sizes[$size] . ' text-back-dark-dark shadow-xs enabled:hover:bg-back-light/60 enabled:dark:hover:bg-back-dark-light/60 focus:outline-hidden focus:ring-1 focus:ring-back-primary dark:focus:ring-back-dark-primary focus:ring-offset-1 transition ease-in-out duration-150';
@endphp
