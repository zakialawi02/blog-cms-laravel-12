    ...
    <nav class="mx-auto flex w-full basis-full items-center px-4 sm:px-6">
        ...
        <div class="ms-auto flex w-full items-center justify-end gap-x-1 md:gap-x-3">
            ...
            <div class="flex flex-row items-center justify-end gap-1">
                ...
                <!-- Dropdown menu -->
                <div class="dark:bg-back-dark-base-200 z-20 hidden w-full max-w-sm divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-700" id="dropdownNotification" aria-labelledby="dropdownNotificationButton">
                    <div class="dark:bg-back-dark-base-200 block rounded-t-lg bg-gray-50 px-4 py-2 text-center font-medium text-gray-700 dark:text-white">
                        Notifications
                    </div>
                ...
                <!-- Dropdown menu -->
                <div class="dark:bg-back-dark-base-200 z-50 my-4 hidden list-none divide-y divide-gray-100 rounded-lg bg-white text-base shadow-sm dark:divide-slate-600" id="user-dropdown">
                    <div class="px-4 py-3">
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        ...
                        @if (Auth::user()->role == 'superadmin')
                            <li>
                                <a class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white" href={{ route('admin.settings.web.index') }}>Settings</a>
                            </li>
                        @endif
                        <li>
