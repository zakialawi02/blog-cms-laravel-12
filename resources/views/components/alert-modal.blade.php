    ...
    <script>
        class PopupAlert {
            ...
            show({
                ...
                confirmButton.className = confirmClass || "text-sm px-4 py-2 text-white bg-back-error rounded-lg hover:bg-back-error/80 focus:outline-none focus:ring-4 focus:ring-back-error dark:focus:ring-back-error/80";
