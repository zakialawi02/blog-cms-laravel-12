    <section class="">
        <div class="w-full">
            <nav class="border-b border-solid border-gray-200 bg-white px-10 py-5 transition-all duration-500 lg:px-14 xl:px-28">
                <div class="px-0 xl:px-8">
                    <div class="flex w-full flex-col justify-between lg:flex-row">
                        <div class="flex justify-between lg:flex-row">
                            ...
                            <button class="ml-3 inline-flex items-center rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 lg:hidden" data-collapse-toggle="navbar-default" type="button" aria-controls="navbar-default" aria-expanded="false">
                        ...
                        <div class="hidden lg:flex lg:pl-11" id="navbar-default">
                            <ul class="mt-4 flex-col items-center lg:mt-0 lg:flex lg:flex-row">
                                <li>
                                    <a class="mb-2 mr-4 block px-3 text-center text-base font-medium leading-6 text-gray-900 transition-all duration-700 hover:text-gray-600 md:mb-0 lg:mr-6 lg:text-left" href="javascript:;">Home</a>
                                </li>
                                <li>
                                    <a class="mb-2 mr-4 block break-keep px-0 text-center text-base font-medium leading-6 text-gray-900 transition-all duration-700 hover:text-gray-600 md:mb-0 lg:mr-6 lg:text-left xl:px-3" href="javascript:;">About us</a>
                                </li>
                                <li class="relative">
                                    <button class="hover:text-prime-blue-700 m-auto mb-2 mr-4 flex items-center justify-between px-3 text-center text-base font-medium leading-6 text-gray-900 transition-all duration-500 hover:text-gray-600 lg:m-0 lg:mb-0 lg:mr-6 lg:text-left lg:text-base" data-dropdown-toggle="menu1">Products <svg class="ml-1.5 h-2 w-3" width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <!-- Dropdown menu -->
                                    <div class="animate-fade absolute -left-80 top-14 z-10 hidden min-w-full rounded-lg bg-white p-2 shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] md:min-w-[500px] lg:min-w-[800px] lg:p-4 xl:p-8" id="menu1">
                                        <div class="flex justify-between">
                                            <ul class="w-1/2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                                <h6 class="mb-2 text-base font-medium leading-6 text-gray-900">Features</h6>
                                                <li class="">
                                                    <a class="flex items-center px-3 py-5 transition-all duration-500 hover:rounded-xl hover:bg-gray-50" href="javascript:;">
                                                        ...
                                                        <div class="ml-4 w-4/5">
                                                            <h5 class="mb-1.5 text-base font-semibold text-gray-900"> Notification</h5>
                                                            <p class="text-xs font-medium text-gray-400">Real time notification always keep you up to date in realtime</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a class="flex items-center px-3 py-5 transition-all duration-500 hover:rounded-xl hover:bg-gray-50" href="javascript:;">
                                                        ...
                                                        <div class="ml-4 w-4/5">
                                                            <h5 class="mb-1.5 text-base font-semibold text-gray-900">Analytics <span class="ml-4 mr-2 h-5 rounded-full bg-indigo-50 px-2.5 py-1 text-xs font-medium text-indigo-500">New</span>
                                                            </h5>
                                                            <p class="text-xs font-medium text-gray-400">Analyze data to make more informed and accurate business decision</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a class="flex items-center px-3 py-5 transition-all duration-500 hover:rounded-xl hover:bg-gray-50" href="javascript:;">
                                                        ...
                                                        <div class="ml-4 w-4/5">
                                                            <h5 class="mb-1.5 text-base font-semibold text-gray-900"> Integrations</h5>
                                                            <p class="text-xs font-medium text-gray-400">Get started by taking advantage of integration with other services</p>
                                                        </div>
                                                    </a>
                                                </li>
                                            </ul>
                                            <ul class="w-1/2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                                <h6 class="mb-2 text-sm font-medium text-gray-500">Services</h6>
                                                <li class="">
                                                    <a class="flex items-center px-3 py-5 transition-all duration-500 hover:rounded-xl hover:bg-gray-50" href="javascript:;">
                                                        <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-rose-50">
                                                            <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div class="ml-4 w-4/5">
                                                            <h5 class="mb-1.5 text-base font-semibold text-gray-900">Security </h5>
                                                            <p class="text-xs font-medium text-gray-400">To ensure your privacy all information are highly encrypted </p>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a class="flex items-center px-3 py-5 transition-all duration-500 hover:rounded-xl hover:bg-gray-50" href="javascript:;">
                                                        ...
                                                        <div class="ml-4 w-4/5">
                                                            <h5 class="mb-1.5 text-base font-semibold text-gray-900"> Documentation</h5>
                                                            <p class="text-xs font-medium text-gray-400">Organized documentation will help you save tone of your time </p>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a class="flex items-center px-3 py-5 transition-all duration-500 hover:rounded-xl hover:bg-gray-50" href="javascript:;">
                                                        ...
                                                        <div class="ml-4 w-4/5">
                                                            <h5 class="mb-1.5 text-base font-semibold text-gray-900">Support </h5>
                                                            <p class="text-xs font-medium text-gray-400">Need help? our customer support is here to help you anytime</p>
                                                        </div>
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <li class="relative">
                                    <button class="hover:text-prime-blue-700 m-auto mb-2 mr-4 flex items-center justify-between px-3 text-center text-base font-medium leading-6 text-gray-900 transition-all duration-500 hover:text-gray-600 lg:m-0 lg:mb-0 lg:mr-6 lg:text-left lg:text-base" data-dropdown-toggle="menu2">Features <svg class="ml-1.5 h-2 w-3" width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 1L3.58579 3.58579C4.25245 4.25245 4.58579 4.58579 5 4.58579C5.41421 4.58579 5.74755 4.25245 6.41421 3.58579L9 1" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </button>
                                    <!-- Dropdown menu -->
                                    <div class="dropdown-menu absolute top-14 z-10 hidden w-64 rounded-lg bg-white p-2 font-normal shadow-[0px_15px_30px_-4px_rgba(16,24,40,0.03)] lg:p-4 xl:p-8" id="menu2">
                                        <ul class="text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                            <h6 class="mb-2 text-sm font-medium text-gray-500">Features</h6>
                                            <li>
                                                <a class="hover:text-prime-blue-700 block py-3 text-base font-semibold text-gray-900 transition-all duration-500" href="javascript:;">Notification</a>
                                            </li>
                                            <li>
                                                <a class="hover:text-prime-blue-700 block py-3 text-base font-semibold text-gray-900 transition-all duration-500" href="javascript:;">Analytics</a>
                                            </li>
                                            <li>
                                                <a class="hover:text-prime-blue-700 block py-3 text-base font-semibold text-gray-900 transition-all duration-500" href="javascript:;">Integrations</a>
                                            </li>
                                            <li>
                                                <a class="hover:text-prime-blue-700 block py-3 text-base font-semibold text-gray-900 transition-all duration-500" href="javascript:;">Security</a>
                                            </li>
                                            <li>
                                                <a class="hover:text-prime-blue-700 block py-3 text-base font-semibold text-gray-900 transition-all duration-500" href="javascript:;">Documentation</a>
                                            </li>
                                            <li>
                                                <a class="hover:text-prime-blue-700 block py-3 text-base font-semibold text-gray-900 transition-all duration-500" href="javascript:;">Support</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                            <div class="ml-2 flex items-center justify-center gap-x-5 xl:ml-14">
                                <button class="h-11 w-20 rounded-full bg-indigo-600 text-sm font-semibold leading-5 text-white transition-all duration-700 hover:bg-indigo-800">Login </button>
                                <button class="h-11 w-24 rounded-full bg-gray-900 text-sm font-semibold leading-5 text-white shadow-sm transition-all duration-700 hover:bg-gray-800">Sign up </button>
                            </div>
                        </div>
                    </div>
                </div>
            </nav>
            <div class="px-10 py-10 md:py-20 xl:px-0 xl:py-28">
                <span class="mx-auto mb-5 flex w-fit items-center justify-center rounded-full bg-emerald-50 px-3 py-1 text-center text-sm font-medium leading-5 text-emerald-600">Careers at Pagedone</span>
                <h1 class="font-manrope mb-8 text-center text-4xl font-bold leading-tight text-gray-900 lg:text-5xl">Unlock new career <br> opportunities at Pagedone </h1>
                <p class="text-center text-lg font-normal leading-7 text-gray-900">Pagedone embraces a youthful and flexible spirit, enabling us to swiftly adapt to market research, <br> conditions, and customer demands through our advanced technology. </p>
            </div>
            <div class="bg-slate-50 px-10 py-10 md:py-16 lg:py-24 xl:px-0">
                <h2 class="font-manrope mb-14 text-center text-3xl font-bold leading-10 text-gray-900 lg:text-4xl">Open positions</h2>
                <div class="mx-auto max-w-sm rounded-2xl border border-slate-200 bg-white p-12 sm:max-w-md md:max-w-xl lg:max-w-3xl">
                    <div class="flex justify-between gap-x-8 border-b border-gray-200 pb-6">
                        <h3 class="text-xl font-medium leading-8 text-gray-900">UX Designer</h3>
                        <button class="h-9 w-20 rounded-full bg-indigo-50 text-xs font-semibold leading-4 text-indigo-600 transition-all duration-700 hover:bg-indigo-100">Apply</button>
                    </div>
                    <div class="flex justify-between gap-x-8 border-b border-gray-200 py-6">
                        <h3 class="text-xl font-medium leading-8 text-indigo-600">Motion Designer</h3>
                        <button class="h-9 w-20 rounded-full bg-indigo-50 text-xs font-semibold leading-4 text-indigo-600 transition-all duration-700 hover:bg-indigo-100">Apply</button>
                    </div>
                    <div class="flex justify-between gap-x-8 border-b border-gray-200 py-6">
                        <h3 class="text-xl font-medium leading-8 text-gray-900">iOS Developer</h3>
                        <button class="h-9 w-20 rounded-full bg-indigo-50 text-xs font-semibold leading-4 text-indigo-600 transition-all duration-700 hover:bg-indigo-100">Apply</button>
                    </div>
                    <div class="flex justify-between gap-x-8 border-b border-gray-200 py-6">
                        <h3 class="text-xl font-medium leading-8 text-gray-900">Product Designer</h3>
                        <button class="h-9 w-20 rounded-full bg-indigo-50 text-xs font-semibold leading-4 text-indigo-600 transition-all duration-700 hover:bg-indigo-100">Apply</button>
                    </div>
                    <div class="flex justify-between gap-x-8 border-b border-gray-200 py-6">
                        <h3 class="text-xl font-medium leading-8 text-gray-900">UX Researcher</h3>
                        <button class="h-9 w-20 rounded-full bg-indigo-50 text-xs font-semibold leading-4 text-indigo-600 transition-all duration-700 hover:bg-indigo-100">Apply</button>
                    </div>
                    <div class="flex justify-between gap-x-8 pt-6">
                        <h3 class="text-xl font-medium leading-8 text-gray-900">Project Manager</h3>
                        <button class="h-9 w-20 rounded-full bg-indigo-50 text-xs font-semibold leading-4 text-indigo-600 transition-all duration-700 hover:bg-indigo-100">Apply</button>
                    </div>
                </div>
            </div>
            <div class="mx-auto w-auto px-10 py-10 md:py-16 xl:max-w-6xl xl:px-0 xl:py-28">
                <h3 class="mb-5 text-center text-3xl font-bold leading-10 text-gray-900 lg:text-4xl">Pagedone thrives on a spirit of agility</h3>
                <p class="mb-6 text-center text-lg font-normal leading-7 text-gray-500 lg:mb-14">We want to provide a user friendly experience with the eyes capture design and develop product <br> quickly with the ability to solve user problems. </p>
                <div class="mx-auto grid max-w-lg grid-cols-1 gap-x-4 gap-y-4 border-b border-gray-200 pb-10 md:max-w-3xl md:grid-cols-2 lg:max-w-full lg:grid-cols-3 lg:gap-x-8 lg:pb-24">
                    <div class="group cursor-pointer p-8 transition-all duration-500 hover:rounded-2xl hover:shadow-md">
                        <div class="mb-5 flex h-20 w-20 items-center justify-center rounded-xl bg-indigo-50 transition-all duration-500 group-hover:bg-indigo-600 max-lg:mx-auto">
                        ...
                        <h4 class="mb-3 text-lg font-semibold leading-7 text-gray-900 max-lg:text-center">Leadership</h4>
                        <p class="text-sm font-normal leading-5 text-gray-500 max-lg:text-center">Build your beautiful agency website with us that converts more visitors than any other website and the ability to interact and rotate products to solve user problems.</p>
                    </div>
                    <div class="group cursor-pointer p-8 transition-all duration-500 hover:rounded-2xl hover:shadow-md">
                        <div class="mb-5 flex h-20 w-20 items-center justify-center rounded-xl bg-indigo-50 transition-all duration-500 group-hover:bg-indigo-600 max-lg:mx-auto">
                            <svg class="stroke-indigo-600 transition-all duration-500 group-hover:stroke-indigo-50" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 27.5C21.9036 27.5 27.5 21.9036 27.5 15C27.5 8.09644 21.9036 2.5 15 2.5C8.09644 2.5 2.5 8.09644 2.5 15C2.5 16.5284 2.77429 17.9926 3.27634 19.3463C3.4113 19.7102 3.47878 19.8922 3.49558 20.0461C3.51237 20.2 3.48933 20.3661 3.44327 20.6983L3.01762 23.7676C2.78365 25.4547 2.66667 26.2982 3.16937 26.7423C3.67207 27.1864 4.49475 26.9663 6.1401 26.526L7.74898 26.0956C8.2212 25.9692 8.45731 25.906 8.67831 25.926C8.8993 25.9459 9.15538 26.0669 9.66748 26.3088C11.2849 27.0728 13.0925 27.5 15 27.5Z" stroke="" stroke-width="2" stroke-linecap="round" />
                            </svg>
                        </div>
                        <h4 class="mb-3 text-lg font-semibold leading-7 text-gray-900 max-lg:text-center">Communication</h4>
                        <p class="text-sm font-normal leading-5 text-gray-500 max-lg:text-center">Build your beautiful agency website with us that converts more visitors than any other website and the ability to interact and rotate products to solve user problems.</p>
                    </div>
                    <div class="group cursor-pointer px-8 pb-4 pt-8 transition-all duration-500 hover:rounded-2xl hover:shadow-md md:col-span-2 md:mx-auto md:w-1/2 lg:col-span-1 lg:w-full lg:pb-8">
                        <div class="mb-5 flex h-20 w-20 items-center justify-center rounded-xl bg-indigo-50 transition-all duration-500 group-hover:bg-indigo-600 max-lg:mx-auto">
                            <svg class="fill-indigo-600 transition-all duration-500 group-hover:fill-indigo-50" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <h4 class="mb-3 text-lg font-semibold leading-7 text-gray-900 max-lg:text-center">Commitment</h4>
                        <p class="text-sm font-normal leading-5 text-gray-500 max-lg:text-center">Build your beautiful agency website with us that converts more visitors than any other website and the ability to interact and rotate products to solve user problems.</p>
                    </div>
                </div>
                <div class="mt-10 rounded-2xl bg-gradient-to-l from-violet-600 to-indigo-600 p-12 lg:mt-24">
                    <div class="items-center justify-between gap-6 lg:flex">
                        <div class="mb-10 lg:mb-0">
                            <h3 class="font-manrope mb-5 text-3xl font-semibold leading-10 text-white lg:text-4xl">Don't see the role you're interested in?</h3>
                            <p class="text-xl font-normal leading-8 text-indigo-100">We’re always looking for talented people to join our team. Send us your CV and we will contact you for any future roles.</p>
                        </div>
                        <button class="flex h-14 items-center justify-center gap-2 whitespace-nowrap rounded-full bg-white px-2.5 text-lg font-semibold leading-7 text-indigo-600"> Send Your CV <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.75 11L17.4167 11M12.8333 16.5L17.6852 11.6482C17.9907 11.3426 18.1435 11.1898 18.1435 11C18.1435 10.8102 17.9907 10.6574 17.6852 10.3518L12.8333 5.5" stroke="#4F46E5" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </div>
                </div>
            </div>
            <footer class="w-full px-10 xl:px-0">
                <div class="mx-auto max-w-6xl">
                    <!--Grid-->
                    <div class="grid grid-cols-2 gap-8 py-10 max-md:mx-auto max-md:max-w-md md:grid-cols-4 lg:grid-cols-6">
                        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                            <a class="flex justify-center lg:justify-start" href="javascript:;">
                                <svg class="h-8 w-40" viewBox="0 0 164 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M47 24.7231V7H54.4171C54.5916 7 54.816 7.00821 55.0903 7.02462C55.3645 7.03282 55.618 7.05744 55.8507 7.09846C56.8895 7.25436 57.7455 7.59487 58.4186 8.12C59.1001 8.64513 59.6029 9.30974 59.927 10.1138C60.2594 10.9097 60.4256 11.7959 60.4256 12.7723C60.4256 13.7405 60.2594 14.6267 59.927 15.4308C59.5945 16.2267 59.0876 16.8872 58.4061 17.4123C57.733 17.9374 56.8812 18.2779 55.8507 18.4338C55.618 18.4667 55.3604 18.4913 55.0778 18.5077C54.8035 18.5241 54.5833 18.5323 54.4171 18.5323H50.0042V24.7231H47ZM50.0042 15.7631H54.2925C54.4587 15.7631 54.6457 15.7549 54.8534 15.7385C55.0612 15.7221 55.2523 15.6892 55.4268 15.64C55.9255 15.5169 56.3161 15.2995 56.5986 14.9877C56.8895 14.6759 57.0931 14.3231 57.2094 13.9292C57.3341 13.5354 57.3964 13.1497 57.3964 12.7723C57.3964 12.3949 57.3341 12.0092 57.2094 11.6154C57.0931 11.2133 56.8895 10.8564 56.5986 10.5446C56.3161 10.2328 55.9255 10.0154 55.4268 9.89231C55.2523 9.84308 55.0612 9.81436 54.8534 9.80615C54.6457 9.78974 54.4587 9.78154 54.2925 9.78154H50.0042V15.7631Z" fill="#111827" />
                            ...
                            <p class="py-8 text-center text-sm text-gray-500 lg:max-w-xs lg:text-left">Trusted in more than 100 countries & 5 million customers. Have any query ?</p>
                            <a class="mx-auto block h-9 w-fit rounded-full bg-indigo-600 px-5 py-2.5 text-xs text-white shadow-sm transition-all duration-500 hover:bg-indigo-700 lg:mx-0" href="javascript:;"> Contact us </a>
                        </div>
                        <!--End Col-->
                        <div class="lg:mx-auto">
                            ...
                            <ul class="text-sm transition-all duration-500">
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Home</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">About</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Pricing</a>
                                </li>
                                <li>
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Features</a>
                                </li>
                            </ul>
                        </div>
                        <!--End Col-->
                        <div class="lg:mx-auto">
                            ...
                            <ul class="text-sm transition-all duration-500">
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Figma UI System</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Icons Assets</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Responsive Blocks</a>
                                </li>
                                <li>
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Components Library</a>
                                </li>
                            </ul>
                        </div>
                        <!--End Col-->
                        <div class="lg:mx-auto">
                            ...
                            <ul class="text-sm transition-all duration-500">
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">FAQs</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Quick Start</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Documentation</a>
                                </li>
                                <li>
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">User Guide</a>
                                </li>
                            </ul>
                        </div>
                        <!--End Col-->
                        <div class="lg:mx-auto">
                            ...
                            <ul class="text-sm transition-all duration-500">
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">News</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Tips & Tricks</a>
                                </li>
                                <li class="mb-6">
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">New Updates</a>
                                </li>
                                <li>
                                    <a class="text-gray-600 hover:text-gray-900" href="javascript:;">Events</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 py-7">
                        <div class="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
                            <span class="mb-4 text-sm text-gray-500 lg:mb-0">©pagedone 2024, All rights reserved.</span>
                            <div class="mt-4 flex space-x-4 sm:mt-0 sm:justify-center">
                                <a class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-700 hover:bg-indigo-600" href="javascript:;">
                                ...
                                <a class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-700 hover:bg-indigo-600" href="javascript:;">
                                    <svg class="h-[1.125rem] w-[1.25rem] text-white" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-700 hover:bg-indigo-600" href="javascript:;">
                                    <svg class="h-[1rem] w-[1rem] text-white" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-700 hover:bg-indigo-600" href="javascript:;">
                                    <svg class="h-[0.875rem] w-[1.25rem] text-white" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
