    ...
    <header class="mb-8 border-b">
        <div class="mx-auto flex max-w-screen-2xl items-center justify-between px-4 md:px-8">
            ...
            <nav class="hidden gap-12 lg:flex 2xl:ml-16">
                ...
                <a class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700" href="#">Collections</a>
                <a class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700" href="#">Sale</a>
            ...
            <div class="flex divide-x border-r sm:border-l">
                <a class="hidden h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:flex sm:h-20 sm:w-20 md:h-24 md:w-24" href="#">
                ...
                <a class="flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24" href="#">
                    <svg class="h-6 w-6 text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button class="flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24 lg:hidden" type="button">
    ...
    <section class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="mb-8 flex flex-wrap justify-between md:mb-16">
            ...
            <div class="mb-12 flex w-full md:mb-16 lg:w-2/3">
                <div class="relative left-12 top-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:ml-0">
                    <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1542340916-951bb72c8f74?auto=format&q=75&fit=crop&w=550&h=550" alt="Photo by Kaung Htet" loading="lazy" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100 shadow-lg">
                    <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1586295166487-b265f7e83a7f?auto=format&q=75&fit=crop&w=550&h=550" alt="Photo by Manny Moreno" loading="lazy" />
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div class="flex h-12 w-64 divide-x overflow-hidden rounded-lg border">
                <a class="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200" href="#">Men</a>
                <a class="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200" href="#">Women</a>
                <a class="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200" href="#">Teens</a>
            </div>
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
            <!-- product - start -->
            <div>
                <a class="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3" href="#">
                ...
                <div class="flex items-start justify-between gap-2 px-2">
                    <div class="flex flex-col">
                        <a class="text-lg font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl" href="#">Fancy Outfit</a>
            ...
            <div>
                ...
                <div class="flex items-start justify-between gap-2 px-2">
                    <div class="flex flex-col">
                        <a class="text-lg font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl" href="#">Cool Outfit</a>
            ...
            <div>
                ...
                <div class="flex items-start justify-between gap-2 px-2">
                    <div class="flex flex-col">
                        <a class="text-lg font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl" href="#">Nice Outfit</a>
            ...
            <div>
                ...
                <div class="flex items-start justify-between gap-2 px-2">
                    <div class="flex flex-col">
                        <a class="text-lg font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl" href="#">Lavish Outfit</a>
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="flex flex-col overflow-hidden rounded-lg bg-gray-900 sm:flex-row md:h-80">
            ...
            <div class="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-2/5">
                ...
                <div class="mt-auto">
                    <a class="inline-block rounded-lg bg-white px-8 py-3 text-center text-sm font-semibold text-gray-800 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:text-base" href="#">Save now</a>
                </div>
            </div>
            <!-- content - end -->
            ...
            <div class="order-first h-48 w-full bg-gray-700 sm:order-none sm:h-auto sm:w-1/2 lg:w-3/5">
                <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1505846951821-e25bacf2eccd?auto=format&q=75&fit=crop&crop=top&w=1000&h=500" alt="Photo by Dom Hill" loading="lazy" />
            </div>
            <!-- image - end -->
        </div>
    </div>
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4">
            <!-- product - start -->
            <div>
                <a class="group relative flex h-96 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg" href="#">
                    <img class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" src="https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?auto=format&q=75&fit=crop&crop=top&w=600&h=700" alt="Photo by Austin Wade" loading="lazy" />
            ...
            <div>
                <a class="group relative flex h-96 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg" href="#">
                    <img class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" src="https://images.unsplash.com/photo-1603344797033-f0f4f587ab60?auto=format&q=75&fit=crop&crop=top&w=600&h=700" alt="Photo by engin akyurt" loading="lazy" />
            ...
            <div>
                <a class="group relative flex h-96 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg" href="#">
                    <img class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" src="https://images.unsplash.com/photo-1552668693-d0738e00eca8?auto=format&q=75&fit=crop&crop=top&w=600&h=700" alt="Photo by Austin Wade" loading="lazy" />
            ...
            <div>
                <a class="group relative flex h-96 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg" href="#">
                    <img class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" src="https://images.unsplash.com/photo-1560269999-cef6ebd23ad3?auto=format&q=75&fit=crop&w=600&h=700" alt="Photo by Austin Wade" loading="lazy" />
