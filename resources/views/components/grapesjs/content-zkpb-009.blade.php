        ...
        <div class="grid gap-8 md:grid-cols-2 lg:gap-12">
            <div>
                <div class="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
                    <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1610465299996-30f240ac2b1c?auto=format&q=75&fit=crop&w=600&h=750" alt="Photo by Martin Sanchez" loading="lazy" />
                </div>
            </div>
            ...
            <div class="md:pt-8">
                ...
                <p class="mb-6 text-gray-500 sm:text-lg md:mb-8">
                    ...
                    This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is <a class="text-indigo-500 underline transition duration-100 hover:text-indigo-600 active:text-indigo-700" href="#">random</a> or otherwise generated. It may be used to display a sample of fonts or generate text for testing. Filler text is dummy text which has no meaning however looks very similar to real text.
                </p>
