    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
            ...
            <div class="h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:h-auto xl:w-5/12">
                <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1618004912476-29818d81ae2e?auto=format&q=75&fit=crop&w=1000" alt="Photo by Fakurian Design" loading="lazy" />
            </div>
            <!-- image - end -->
        </section>
    </div>
        ...
        <div class="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
            ...
            <div class="flex gap-4 md:gap-6">
                ...
                <div>
                    ...
                    <a class="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700" href="#">More</a>
                </div>
            </div>
            <!-- feature - end -->
...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div class="grid grid-cols-2 gap-6 rounded-lg bg-gray-100 p-6 sm:h-40 sm:content-evenly md:grid-cols-4">
            <!-- logo - start -->
            <div class="flex justify-center text-gray-400">
                <svg class="h-6 w-auto sm:h-8 lg:h-10" width="154" height="39" viewBox="0 0 154 39" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- logo - start -->
            <div class="flex justify-center text-gray-400">
                <svg class="h-6 w-auto sm:h-8 lg:h-10" width="173" height="39" viewBox="0 0 173 39" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    <div class="mx-auto max-w-screen-xl px-4 md:px-8">
        ...
        <div class="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x">
            ...
            <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
                ...
                <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                    <div class="h-12 w-12 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-14 md:w-14">
                        <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1567515004624-219c11d31f2e??auto=format&q=75&fit=crop&w=112" alt="Photo by Radu Florin" loading="lazy" />
                    </div>
            ...
            <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
                ...
                <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                    <div class="h-12 w-12 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-14 md:w-14">
                        <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1532073150508-0c1df022bdd1?auto=format&q=75&fit=crop&w=112" alt="Photo by christian ferrer" loading="lazy" />
                    </div>
            ...
            <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
                ...
                <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                    <div class="h-12 w-12 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-14 md:w-14">
                        <img class="h-full w-full object-cover object-center" src="https://images.unsplash.com/photo-1463453091185-61582044d556?auto=format&q=75&fit=crop&w=500" alt="Photo by Ayo Ogunseinde" loading="lazy" />
                    </div>
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8">
            ...
            <form class="mb-3 flex w-full max-w-md gap-2 sm:mb-5">
                <input class="bg-gray-white w-full flex-1 rounded border border-gray-300 px-3 py-2 text-gray-800 placeholder-gray-400 outline-none ring-indigo-300 transition duration-100 focus:ring" placeholder="Email" />
            ...
            <p class="text-center text-xs text-gray-400">By signing up to our newsletter you agree to our <a class="underline transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Term of Service</a> and <a class="underline transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Privacy Policy</a>.</p>
        </div>
    </div>
</div>
<!-- newsletter - end -->
        ...
        <div class="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
            <div class="col-span-full lg:col-span-2">
                ...
                <div class="mb-4 lg:-mt-2">
                    <a class="inline-flex items-center gap-2 text-xl font-bold text-gray-100 md:text-2xl" href="/" aria-label="logo">
            ...
            <div>
                ...
                <nav class="flex flex-col gap-4">
                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Overview</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Solutions</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Pricing</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Customers</a>
                    </div>
                </nav>
            </div>
            <!-- nav - end -->
            ...
            <div>
                ...
                <nav class="flex flex-col gap-4">
                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">About</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Investor Relations</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Jobs</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Press</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Blog</a>
                    </div>
                </nav>
            </div>
            <!-- nav - end -->
            ...
            <div>
                ...
                <nav class="flex flex-col gap-4">
                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Contact</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Documentation</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Chat</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">FAQ</a>
                    </div>
                </nav>
            </div>
            <!-- nav - end -->
            ...
            <div>
                ...
                <nav class="flex flex-col gap-4">
                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Terms of Service</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Privacy Policy</a>
                    </div>

                    <div>
                        <a class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600" href="#">Cookie settings</a>
                    </div>
                </nav>
            </div>
            <!-- nav - end -->
