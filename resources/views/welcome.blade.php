            ...
            <style>
                ...
                @layer theme {
                    ...
                    :host {
                        ...
                        --color-back-neutral-50: oklch(.985 0 0);
                        --color-back-neutral-100: oklch(.97 0 0);
                        --color-back-neutral-200: oklch(.922 0 0);
                        --color-back-neutral-300: oklch(.87 0 0);
                        --color-back-neutral-400: oklch(.708 0 0);
                        --color-back-neutral-500: oklch(.556 0 0);
                        --color-back-neutral-600: oklch(.439 0 0);
                        --color-back-neutral-700: oklch(.371 0 0);
                        --color-back-neutral-800: oklch(.269 0 0);
                        --color-back-neutral-900: oklch(.205 0 0);
                        --color-back-neutral-950: oklch(.145 0 0);
        ...
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] text-sm lg:max-w-4xl">
            @if (Route::has('login'))
                <nav class="flex items-center justify-end gap-4">
                    <a class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]" href="{{ url('/docs') }}">
                        Route Docs
                    </a>
                ...
                <div class="flex-1 rounded-bl-lg rounded-br-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-br-none lg:rounded-tl-lg lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li class="relative flex items-center gap-4 py-2 before:absolute before:bottom-0 before:left-[0.4rem] before:top-1/2 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                            ...
                            <span>
                                Read the
                                <a class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]" href="https://laravel.com/docs" target="_blank">
                        ...
                        <li class="relative flex items-center gap-4 py-2 before:absolute before:bottom-1/2 before:left-[0.4rem] before:top-0 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                            ...
                            <span>
                                ...
                                <a class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]" href="https://laracasts.com" target="_blank">
                                    <span>Laracasts</span>
                                    <svg class="h-2.5 w-2.5" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.70833 6.95834V2.79167H3.54167M2.5 8L7.5 3.00001" stroke="currentColor" stroke-linecap="square" />
                                    </svg>
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a class="inline-block rounded-sm border border-black bg-[#1b1b18] px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white" href="https://cloud.laravel.com" target="_blank">
                                Deploy now
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none dark:bg-[#1D0002]">
                    {{-- Laravel Logo --}}
                    <svg class="duration-750 starting:opacity-0 starting:translate-y-6 w-full max-w-none translate-y-0 text-[#F53003] opacity-100 transition-all dark:text-[#F61500]" viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- Light Mode 12 SVG --}}
                    <svg class="relative -ml-8 -mt-[4.9rem] w-[448px] max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:hidden" viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g class="duration-750 starting:opacity-0 starting:translate-y-4 translate-y-0 opacity-100 transition-all delay-300" style="mix-blend-mode: hard-back-light">
                        ...
                        <g class="duration-750 starting:opacity-0 starting:translate-y-4 translate-y-0 opacity-100 transition-all delay-300" style="mix-blend-mode: plus-darker">
                    ...
                    {{-- Dark Mode 12 SVG --}}
                    <svg class="relative -ml-8 -mt-[4.9rem] hidden w-[448px] max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:block" viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g class="duration-750 starting:opacity-0 starting:translate-y-4 translate-y-0 opacity-100 transition-all delay-300">
                            <path d="M188.263 355.73L188.595 355.73C195.441 348.845 205.766 339.761 219.569 328.477C232.93 317.193 242.978 308.205 249.714 301.511C256.34 294.626 260.867 287.358 263.296 279.708C265.725 272.058 264.565 264.121 259.816 255.896C254.516 246.716 247.062 239.352 237.454 233.805C227.957 228.067 217.908 225.198 207.307 225.198C196.927 225.197 190.136 227.97 186.934 233.516C183.621 238.872 184.726 246.331 190.247 255.894L125.647 255.891C116.371 239.825 112.395 225.481 113.72 212.858C115.265 200.235 121.559 190.481 132.602 183.596C143.754 176.52 158.607 172.982 177.159 172.983C196.594 172.984 215.863 176.523 234.968 183.6C253.961 190.486 271.299 200.241 286.98 212.864C302.661 225.488 315.14 239.833 324.416 255.899C333.03 270.817 336.841 283.918 335.847 295.203C335.075 306.487 331.376 316.336 324.75 324.751C318.346 333.167 308.408 343.494 294.936 355.734L377.094 355.737L405.917 405.656L217.087 405.649L188.263 355.73Z" fill="black" />
                            <path d="M9.11884 226.339L-13.7396 226.338L-42.7286 176.132L43.0733 176.135L175.595 405.649L112.651 405.647L9.11884 226.339Z" fill="black" />
                    ...
                    <div class="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-r-lg lg:rounded-t-none dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"></div>
                </div>
            </main>
        </div>
