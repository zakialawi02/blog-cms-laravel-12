                ...
                <x-card class="">
                    <div class="mb-2 flex items-center justify-between">
                        <div class="">
                            ...
                            <p class="text-back-muted dark:text-back-dark-muted">Your recently created blog posts</p>
                        </div>
                ...
                <x-card>
                    <div class="mb-2 flex items-center justify-between">
                        <div class="">
                            ...
                            <p class="text-back-muted dark:text-back-dark-muted">Your most viewed content post</p>
                        </div>
