...
<x-app-layout>
    <section class="p-1 pt-3 md:px-4">
        <x-card>
            <form class="my-form-input" id="form-page" action="{{ route('admin.pages.store') }}" method="POST">
                @csrf

                <div class="mb-3">
                    <x-dashboard.input-label for="title" value="{{ __('Title') }}"></x-dashboard.input-label>
                    <x-dashboard.text-input class="mt-1 block w-full" id="title" name="title" type="text" :value="old('title')" placeholder="Enter title" required autofocus />
                ...
                <div class="mb-3">
                    ...
                    <x-dashboard.textarea-input class="mt-1 block w-full" id="description" name="description" type="text" :value="old('description')" placeholder="Enter description" maxlength="255" rows="5" required autofocus />
                ...
                <div class="mb-3">
                    ...
                    <div class="relative mt-2.5">
                        ...
                        <x-dashboard.text-input class="px-3.5 py-2 pl-48 focus:ring-inset sm:text-sm sm:leading-6" id="slug" name="slug" type="text" value="" placeholder="enter-slug-here" required="" maxlength="255">
                ...
                <div class="mb-3">
                    ...
                    <div class="flex items-center gap-x-3">
                        <input class="focus:ring-back-primary dark:focus:ring-back-dark-primary focus:border-back-primary dark:focus:border-back-dark-primary h-4 w-4" id="fullWidth" name="template_id" type="radio" value="1" checked="">
                        <label class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-300" for="fullWidth">Full Width</label>
                    </div>
                    <div class="flex items-center gap-x-3">
                        <input class="focus:ring-back-primary dark:focus:ring-back-dark-primary focus:border-back-primary dark:focus:border-back-dark-primary h-4 w-4" id="canvas" name="template_id" type="radio" value="0">
