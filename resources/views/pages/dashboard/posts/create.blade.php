    ...
    <section class="p-1 md:p-4">
        ...
        <form class="" id="post-form" action="{{ route('admin.posts.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="lg:col-span-2">
                            <x-card>
                                <div class="mb-3">
                                    ...
                                    <x-dashboard.text-input class="mt-1" id="title" name="title" type="text" :value="old('title')" placeholder="title" required autofocus />
                        ...
                        <div class="">
                            <x-card>
                                <div class="mb-3">
                                    ...
                                    <div class="relative">
                                        <x-dashboard.text-input class="mt-1" id="slug" name="slug" type="text" :value="old('slug')" placeholder="slug-url" readonly required />
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-dashboard.text-input class="" id="published_at" name="published_at" type="datetime-local" placeholder="Click for choose publish datetime" :value="old('published_at')" />
                ...
                <div class="hidden" id="styled-metadata" role="tabpanel" aria-labelledby="metadata-tab">
                    <x-card>
                        <div class="mb-3">
                            ...
                            <x-dashboard.text-input class="mt-1" id="meta_title" name="meta_title" type="text" :value="old('meta_title')" placeholder="SEO meta title" />
            ...
            <x-card class="my-3 md:my-5">
                ...
                <x-dashboard.input-error class="mt-2" :messages="$errors->get('cover')" />
                <x-dashboard.textarea-input id="content" name="content" rows="4" placeholder="Write your thoughts here...">
                    {{ old('content') }}
                </x-dashboard.textarea-input>
