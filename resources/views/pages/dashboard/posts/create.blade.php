...
<x-app-layout>
    <section class="p-1 md:p-4">
        ...
        <form class="" id="post-form" action="{{ route('admin.posts.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('post')
                        ...
                        <div class="lg:col-span-2">
                            <x-card>
                                <div class="mb-3">
                                    ...
                                    <x-text-input class="mt-1" id="title" name="title" type="text" :value="old('title')" placeholder="title" required autofocus />
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-textarea-input id="excerpt" name="excerpt" rows="4" placeholder="Write your excerpt here...">{{ old('excerpt') }}</x-textarea-input>
                        ...
                        <div class="">
                            <x-card>
                                <div class="mb-3">
                                    ...
                                    <div class="relative">
                                        <x-text-input class="mt-1" id="slug" name="slug" type="text" :value="old('slug')" placeholder="slug-url" readonly required />
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="text-back-muted text-sm dark:text-gray-400">*by default immediately</span>
                                    <x-text-input class="" id="published_at" name="published_at" type="datetime-local" placeholder="Click for choose publish datetime" :value="old('published_at')" />
                ...
                <div class="hidden" id="styled-metadata" role="tabpanel" aria-labelledby="metadata-tab">
                    <x-card>
                        <div class="mb-3">
                            ...
                            <x-text-input class="mt-1" id="meta_title" name="meta_title" type="text" :value="old('meta_title')" placeholder="SEO meta title" />
                        ...
                        <div class="mb-3">
                            ...
                            <x-textarea-input id="meta_desc" name="meta_desc" rows="4" placeholder="Write your meta description here...">
                                {{ old('meta_desc') }}
                            </x-textarea-input>
                        ...
                        <div class="mb-3">
                            ...
                            <x-textarea-input id="meta_keywords" name="meta_keywords" rows="4" placeholder="Enter meta keywords. Eg: keyword1, keyword2, keyword abc, keyword xyz">
                                {{ old('meta_keywords') }}
                            </x-textarea-input>
            ...
            <x-card class="my-3 md:my-5">

                <x-input-label for="cover" :value="__('Content')" />
                <x-input-error class="mt-2" :messages="$errors->get('cover')" />
                <x-textarea-input id="content" name="content" rows="4" placeholder="Write your thoughts here...">
                    {{ old('content') }}
                </x-textarea-input>
